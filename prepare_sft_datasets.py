...
from core.utils.bridge_content_encoder import get_matched_entries
from core.utils.db_utils import get_db_schema
...
if __name__ == "__main__":
    ...
    # Spider development set (1034 examples)
    spider_dev = spider_style_dataset(
        dataset_path = "./data/sft_data_collections/spider-test/test_data/dev.json",
        db_path = "./data/sft_data_collections/spider-test/test_database",
        db_content_index_path = "./data/sft_data_collections/spider-test/db_contents_index",
        source = "spider-test",
        table_json_path = "./data/sft_data_collections/spider-test/test_data/tables.json",
        use_evidence = False,
        mode = "dev"
    )
